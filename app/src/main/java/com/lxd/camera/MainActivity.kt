                ...
                CustomCameraActivity.startCamera(
                    ...
                    callback = object : CameraCallback {
                        override fun onSuccess(uri: Uri) {
                            Log.i("MainActivity", "Photo captured successfully: $uri")
                            imageUri.value = uri
                        }
                        
                        override fun onError(message: String, exception: Exception?) {
                            Log.e("MainActivity", "Photo capture failed: $message", exception)
                        }
                    }
                )
            },
        ...
        Button(
            onClick = {
                ...
                CustomCameraActivity.startCamera(
                    ...
                    callback = object : CameraCallback {
                        override fun onSuccess(uri: Uri) {
                            Log.i("MainActivity", "Video captured successfully: $uri")
                            imageUri.value = uri
                        }
                        
                        override fun onError(message: String, exception: Exception?) {
                            Log.e("MainActivity", "Video capture failed: $message", exception)
                        }
                    },
                    videoDurationLimit = 5
                )
            },
            modifier = Modifier.padding(16.dp)
        ) {
                ...
                modifier = Modifier
                    ...
                    .clickable {
                        ...
                        val intent = Intent(Intent.ACTION_VIEW).apply {
                            setDataAndType(it, if (it.toString().contains("video")) "video/*" else "image/*")
